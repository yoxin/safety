...
public class BlackNumberActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		data = dao.findAll();
		adapter = new BlackNumberAdapter(this,
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			view.setOnLongClickListener(new OnLongClickListener() {
				...
				public boolean onLongClick(View v) {
					...
					View contentView = View.inflate(BlackNumberActivity.this, R.layout.dialog_add_black_number, null);
					tv_title = (TextView)contentView.findViewById(R.id.tv_title);
					et_black_phone = (EditText)contentView.findViewById(R.id.et_black_phone);
					...
					ok.setOnClickListener(new OnClickListener() {
						...
						@Override
						public void onClick(View v) {
							String NewNumber = et_black_phone.getText().toString().trim();
							if (number.isEmpty()) {
								Toast.makeText(BlackNumberActivity.this, "请输入号码", Toast.LENGTH_LONG).show();
								return;
							}
							String NewMode = null;
							if (cb_phone.isChecked()&&cb_sms.isChecked()) {//全部拦截
								...
								Toast.makeText(BlackNumberActivity.this, "请选择模式", Toast.LENGTH_LONG).show();
								return;
							}
							//在数据库修改数据
